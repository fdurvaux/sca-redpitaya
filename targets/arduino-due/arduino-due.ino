/*
#
#	SIMPLE AES - Arduino Due v2
#	AES-256
#	Volatile for having no cache leakages
...
const volatile unsigned char default_key[] = "MySup4Aw3s0meKey!!              ";

const volatile unsigned char sbox[256] = 
{
...
const volatile unsigned char sbox_i[256] = 
{
...
const volatile unsigned char gmul2[256] =
{
...
const volatile unsigned char gmul3[256] =
{
...
const volatile unsigned char rcon[16] = {
...
void setup() {
	...
	// Update: there is no EEPROM in the Arduino Due
	for(int k_i=0; k_i<32; k_i++) {
		// key[k_i] = EEPROM[k_i];
		key[k_i] = default_key[k_i];
	}
	...
	SerialUSB.write("Arduino is ready!\n");
        ...
        *opcode = SerialUSB.read();
				switch(*opcode) {
					...
					case STOR_KEY:
						...
						break;
					case ENC_TXT:
						SerialUSB.write("ACK: ENCRYPT TEXT\n");
						chip_state = ENC_TXT;	
						break;
					case DEC_TXT:
						SerialUSB.write("ACK: DECRYPT TEXT\n");
						chip_state = DEC_TXT;	
						break;
					case REQ_VER:
						SerialUSB.write("ACK: SIMPLE AES - ARDUINO DUE V2\n");
						chip_state = IDLE;
						break;
					default:
						SerialUSB.write("ERR: unknown opcode ");
						SerialUSB.write(*opcode);
						SerialUSB.write("\n");
						chip_state = IDLE;
				}
			}
		...
		case LOAD_KEY:
			if(SerialUSB.available() == 32) {
				SerialUSB.readBytes(key,32);
				SerialUSB.write("ACK: KEY SUCCESSFULLY LOADED IN SRAM\n");
				chip_state = IDLE;
			}
			break;
